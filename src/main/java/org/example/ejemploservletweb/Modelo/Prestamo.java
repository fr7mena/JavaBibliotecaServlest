...
public class Prestamo {
    ...
    public String toString() {
        return String.format("Préstamo: Email -> %s, ejemplar -> %s, Fecha de Inicio -> %s, Fecha de Devolucion -> %s %n", usuario.getEmail(), ejemplar.getId(), fechaInicio, fechaDevolucion);
    }
}